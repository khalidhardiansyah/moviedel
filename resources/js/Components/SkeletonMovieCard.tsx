export default function SkeletonMovieCard() {
    return (
        <div className=" rounded-md relative rounded-m overflow-hidden bg-gray-50/20 animate-pulse min-h-[163px] min-w-[108px] md:min-h-[198px] lg:max-w-40 lg:min-h-60">
